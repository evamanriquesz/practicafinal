...
async function mostrarResultadosFacil(){

    event.preventDefault();

     let resp = await fetch("/api/v1/jugadores/nivel/Facil",{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
               ...
               .then(function (data) {
                           ...
                           //todo lo de mostrar habria que hacerlo aquí o al menos llamar a una función
                               ...
                               const info_jugadores_box = document.getElementById("mostrarResultadosFacil"); //zona para la tabla
                               let table = document.createElement('table');
                               let thead = document.createElement('thead');
                               let tbody = document.createElement('tbody');
...
async function mostrarResultadosMedio(){

    event.preventDefault();

     let resp = await fetch("/api/v1/jugadores/nivel/Medio",{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
               ...
               .then(function (data) {
                           ...
                           //todo lo de mostrar habria que hacerlo aquí o al menos llamar a una función
                               ...
                               const info_jugadores_box = document.getElementById("mostrarResultadosMedio"); //zona para la tabla
                               let table = document.createElement('table');
                               let thead = document.createElement('thead');
                               let tbody = document.createElement('tbody');
...
async function mostrarResultadosDificil(){

    event.preventDefault();

     let resp = await fetch("/api/v1/jugadores/nivel/Dificil",{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
               ...
               .then(function (data) {
                           ...
                           //todo lo de mostrar habria que hacerlo aquí o al menos llamar a una función
                               ...
                               const info_jugadores_box = document.getElementById("mostrarResultadosDificil"); //zona para la tabla
                               let table = document.createElement('table');
                               let thead = document.createElement('thead');
                               let tbody = document.createElement('tbody');
